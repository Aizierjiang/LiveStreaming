...
namespace Unity.Ig.VideoStreaming.Server
{
    public class VideoStreamingServer : MonoBehaviour
    {
        ...
        public Shader RGBToNV12Shader = null;
        ...
        void Start()
        {
            ...
            {
                Debug.LogError("m_SourceTexture is null!");
                return;
            }
            ...
            try
            {
                ...
                if (String.IsNullOrEmpty(m_Username) != String.IsNullOrEmpty(m_Password))
                    ...
                    Debug.Log($"rtsp://{m_Username}:{m_Password}@{GetMyIPAddress()}:{m_Port}");
                ...
                //Aizierjiang added for UI
                ipText.text = "rtsp://" + m_Username + ":" + m_Password + "@" + GetMyIPAddress() + ":" + m_Port;

                //var shaderName = "Video/RGBToNV12";
                //var rgbToNV12Shader = Shader.Find(shaderName);
                var rgbToNV12Shader = RGBToNV12Shader;
                if (rgbToNV12Shader == null)
                    Debug.LogError("Could not find shader1!");
        ...
        void OnDisable()
        {
            // very important to stop here right now incase of port conflict
            m_Server?.StopListen();
        }
